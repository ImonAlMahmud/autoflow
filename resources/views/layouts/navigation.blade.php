        ...
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a
                    ...
                    class="group relative flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('subscription') ? 'bg-indigo-50 text-indigo-600 font-semibold shadow-xs' : 'text-[#667085] hover:text-[#101828] hover:bg-[#F9FAFB]' }}"
                    :title="!sidebarOpen ? 'Subscription & Plans' : ''"
                >
                    <svg class="w-5 h-5 flex-shrink-0 transition-colors {{ request()->routeIs('subscription') ? 'text-indigo-600' : 'text-[#98A2B3] group-hover:text-[#475467]' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
